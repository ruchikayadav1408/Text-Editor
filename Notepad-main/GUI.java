...
public class GUI implements ActionListener{
    ...
    /* Format Menu */
    JMenuItem iWrap, iFontArial , iFontCSMS , iFontTNR ,iFontCON, iFontSize8, iFontSize12 , iFontSize16 , iFontSize20 , iFontSize24 , iFontSize28, iFontSize30 , iFontSize34;
    ...
    public void createFormatMenu(){
        ...
        iFontCON = new JMenuItem("Candara");
        iFontCON.addActionListener(this);
        iFontCON.setActionCommand("Candara");
        menuFont.add(iFontCON);
        ...
        iFontSize34 = new JMenuItem("34");
        iFontSize34.addActionListener(this);
        iFontSize34.setActionCommand("size34");
        menuFontSize.add(iFontSize34);
    }
    ...
    public void createColourMenu(){
        ...
        iCol4 = new JMenuItem("Pink");
        iCol4.addActionListener(this);
        iCol4.setActionCommand("Pink");
        menuColour.add(iCol4);

        iCol5 = new JMenuItem("Yellow");
        iCol5.addActionListener(this);
        iCol5.setActionCommand("Yellow");
        menuColour.add(iCol5);

        iCol6 = new JMenuItem("Orange");
        iCol6.addActionListener(this);
        iCol6.setActionCommand("Orange");
        menuColour.add(iCol6);

        iCol7 = new JMenuItem("Green");
        iCol7.addActionListener(this);
        iCol7.setActionCommand("Green");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        switch(command){
            ...
            case "Times New Roman": format.setFont(command);
                                    break;
            case "Candara": format.setFont(command);
                                    break;                                                                       
            ...
            case "size30"        : format.createFont(30);
                                    break;   
             case "size34"        : format.createFont(34);
                                    break;                                               
